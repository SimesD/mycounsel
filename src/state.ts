...
export type WarningImpact = "HIGH" | "MEDIUM" | "LOW";
...
export interface ContractState {
    ...
    selected_warnings?: number[]; // indices of warnings chosen for the next revision
    lawyer_notes?: string;
...
export const contractStateChannels = {
    ...
    selected_warnings: {
        value: (_a: number[] | undefined, b: number[] | undefined) => b,
